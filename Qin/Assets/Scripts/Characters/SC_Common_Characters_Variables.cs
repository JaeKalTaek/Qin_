...
public class SC_Common_Characters_Variables : MonoBehaviour {
    ...
    [Header("Berserk variables")]
    [Tooltip ("Percentage of Berserk's stats bonus")]
    [Range (0, 100)]
    public int berserkStatsBonusPercentage;

    [Tooltip ("Number by which the stamina threshold will be multiplied")]
    public int berserkStaminaThresholdMultiplier;
    ...
    [Tooltip ("Maximum distance at which two heroes can gain relationship bonuses")]
